...
void VkApp::createScRenderPass()
{
    ...
    result = vkCreateRenderPass(m_device, &renderPassInfo, nullptr, &m_scRenderPass);
    if (result != VK_SUCCESS)
    {
        std::cout << "vkCreateRenderPass failed: " << result << std::endl;
    }
    ...
    if (result != VK_SUCCESS)
    {
        std::cout << "vkCreateFramebuffer failed: " << result << std::endl;
    }
...
void VkApp::createScPipeline()
{
    ...
    VkResult result;
    result = vkCreatePipelineLayout(m_device, &createInfo, nullptr, &m_scPipelineLayout);
    if (result != VK_SUCCESS)
    {
        std::cout << "vkCreatePipelineLayout failed: " << result << std::endl;
    }
    ...
    if (result != VK_SUCCESS)
    {
        std::cout << "vkCreateGraphicsPipelines failed: " << result << std::endl;
    }
...
void VkApp::updateCameraBuffer()
{
    ...
    m_console_out.append(glm::to_string(view)+"\n");
    m_console_out.append(glm::to_string(proj));
